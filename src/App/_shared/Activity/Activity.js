...
} from '../../_services/activity/activity.services'
  ...
  function availabilitiesMeetZoomRequirement() {
    if (select.activity !== undefined) {
      if (select.activity.availabilities !== undefined) {
        ...
        Object.keys(activitySettings.requirements[props.zoomLevel]).forEach(
          (k) => {
  ...
  return (
    <Box sx={{ width: '100%', m: 0, p: 0 }}>
      ...
      >
        <Box
          data-testid={
            'list-activities#listitem-' + props.index + '#box-top dropping area'
          }
          sx={{
            width: '100%',
        ...
        undefined ? null : (
          ...
          >
            ...
            >
              <Typography
                variant={
                  activitySettings.requirements[props.zoomLevel].tasks.variant
                }
                component="span"
              >
              ...
              <IconButton
                data-testid={
                  'list-activities#listitem-' + props.index + '#button-add task'
                }
                onClick={changes.new}
                color="primary"
                size="small"
            ...
            {select.activity.availabilities.tasks !== 'available' ? (
              ...
              >
                <Skeleton variant="text" width={Math.random() * 60 + '%'} />
                <Skeleton
                  variant="text"
              ...
              <List
                dense={false}
                data-testid={
                  'list-activities#listitem-' + props.index + '#list-tasks'
                }
                sx={{
                  width: '95%',
                  p: 0,
                        ...
                        return (
                          ...
                          >
                            <Task
                              ...
                              index={d}
                              prefix={
                                'list-activities#listitem-' + props.index + '#'
                              }
                              disabled={disabled || props.dragging}
